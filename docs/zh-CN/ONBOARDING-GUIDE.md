...
3. [架构总纲](root/ARCHITECTURE.md)和已采纳设计文档；
4. 产品、开发、发布和运行指南；
5. 历史路线图、完成报告和执行记录。

把以下文档加入书签：[架构总纲](root/ARCHITECTURE.md)、
...
> [架构总纲](root/ARCHITECTURE.md) 和 [durable-chat-turn-lifecycle 设计文档](design-docs/durable-chat-turn-lifecycle.md)。
...
- 想懂系统边界：[架构总纲](root/ARCHITECTURE.md) + [功能契约](product-specs/feature-contract.json)。
